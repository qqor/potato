...
def process(fn1, fn2, targetf):
    ...
    for r in res:
        if target_func == "":
            ...
            os.system("cp data_section1.info ~/pin-3.0-76991-gcc-linux/source/tools/IMFSIM/data_section.info")
            F.fuzzing_new(binname1, r[0], r[1][0], r[1][1], cb1, cr1)

            warning("start fuzzing ", binname2, r[0])
            os.system("cp data_section2.info ~/pin-3.0-76991-gcc-linux/source/tools/IMFSIM/data_section.info")
...
if __name__ == '__main__':
    warning("mainmainmainmainmainmainmainmainmainmainmainmainmainmainmainmainmainmainmainmain")
    fn1 = sys.argv[1]
    fn2 = sys.argv[2]
...
if __name__ == '__main__1':
    warning("rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr")
    fn1 = sys.argv[1]
    fn2 = sys.argv[2]
