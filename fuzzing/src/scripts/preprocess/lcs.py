...
def dump_fv_into_file(fn1, fn2, sl):
    ...
    print "[5] dump_fv_into_file finished"
...
def compare_iter_mul(fn1, fn2, fl1, fl2, res):
    ...
    print "[10] ", tabulate(tt, headers=['op1', 'func1', 'op2', 'func2', 'similarity'], tablefmt='orgtbl')
    print ""
    tt = similarity_sort(tt)
    print "[11] ", tabulate(tt, headers=['op1', 'func1', 'op2', 'func2', 'similarity'], tablefmt='orgtbl')
...
def start_threads(res):
    ...
    try:
        ...
        print "[18] Error: unable to start thread"

    print "[19] finish lcs computation"
